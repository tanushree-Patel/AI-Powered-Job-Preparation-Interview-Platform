...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    if (!title.trim()) {
      alert("Please enter a Job Title / Plan Name.")
      return
    }
    ...
    <div className='home-page'>
      ...
      <div className='interview-card'>
        <div className='title-input-section'>
          <label htmlFor="jobTitle" className="section-label">
            Job Title / Plan Name
          ...
          <input
            ...
            placeholder="e.g. Frontend Engineer at Google, Senior Java Developer..."
